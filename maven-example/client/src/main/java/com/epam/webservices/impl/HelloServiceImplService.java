 ...
 * 
 */
@HandlerChain(file = "client-handler.xml")
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.webservices.epam.com/", wsdlLocation = "http://localhost:8084/home/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://impl.webservices.epam.com/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/home/helloService?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://impl.webservices.epam.com/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.webservices.epam.com/", "HelloServiceImplPort"), HelloService.class, features);
    }
